...
let Navbar = () => {
  return (
    <>
      <section className="w-5/6 lg:w-2/4 lg:hover:w-4/6 transition-all duration-200">
        <div className="backdrop-blur-md bg-white/10 border border-white/20 flex justify-between items-center rounded-full px-6 md:px-8 py-3 ">
